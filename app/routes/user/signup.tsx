...
import { FaChevronCircleRight, FaMinusCircle, FaPlusCircle } from "react-icons/fa";
    ...
    return (
        <div className="min-h-screen  bg-white">
            ...
            <section className="w-[40%] mx-auto mt-10">
                {/* App Banner */}
                <div className="mb-8 flex items-center justify-between rounded bg-[#EEF4FA] p-8">
                    <div className="flex items-center gap-8">
                        <img src="/Public/mobile-app-stay-in-touch.png" alt="" className="h-40" />
                        <div>
                            <h2 className="text-4xl text-slate-800">Get the Marcus app</h2>
                            <p className="mt-2 text-2xl text-slate-500">Scan to download or open the app</p>
                        </div>
                        <img src="/Public/mobile-app-stay-in-touch.png" alt="" className="h-40" />
                    </div>
                    <img src="/qr.png" alt="" className="h-28" />
                </div>
                ...
                <div className="">
                    ...
                    {/* Email */}
                    <div className="mb-10">
                        <label className="mb-3 block text-xl text-slate-700">Email address</label>
                    ...
                    {/* Password */}
                    <div>
                        <label className="mb-3 block text-2xl text-slate-700">Password</label>
                ...
                <div className="mx-auto max-w-4xl px-8">
                    ...
                    {/* <div className="w-full max-w-2xl mx-auto text-sm">
                        {FAQs.map((item: { q: string; a: string }, index: number) => {
                            ...
                            return (
                                <div onClick={() => handleActive(index + 1)} className="bg-secondary-light p-3 rounded-3xl mb-2 cursor-pointer active:scale-95 transition-all" key={index}>
                                    <div className="flex items-center border-2 px-4 py-5 border-blue">
                                        <ActiveIcon className="text-blue text-2xl" />
                                        <h1 className="text-base text-blue">{item.q}</h1>
                                    </div>
                                    {exists && <div className="pt-2">{item.a}</div>}
                                </div>
                            );
                        })}
                    </div> */}
                    ...
                    <div className="w-full max-w-2xl mx-auto text-sm">
                        {FAQs.map((item: { q: string; a: string }, index: number) => {
                            ...
                            return (
                                ...
                                >
                                    {/* Question row */}
                                    <div className={`flex items-center gap-3 px-2 py-4 ${exists ? 'border border-blue' : ''}`}>
